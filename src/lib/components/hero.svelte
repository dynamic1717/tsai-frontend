...
<section transition:fade class="text-center">
  ...
  <p class="mx-auto mt-4 max-w-7xl font-semibold text-primary max-lg:text-sm">
    ...
    and cannot provide information that can be misinterpreted.
    <br />
    Here you can get an approximate feel for what it would be like. The chatbot will give the right answers
    but will not allow any specifics, so as not to offend anyone.
  </p>
</section>
